...
class UserReservationListScreen extends StatefulWidget {
  ...
  @override
  State<UserReservationListScreen> createState() => _ReservationListScreenScreenState();
}

class _ReservationListScreenScreenState extends State<UserReservationListScreen> {
  ...
  Widget _buildHeader() {
    return const Padding(
      ...
      child: Text(
        "My Travels",
        style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontSize: 40),
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildDetailRow("- Date: ", x.date.toString()),
            _buildDetailRow("- Status: ", x.status!, isStatus: true),
            _buildDetailRow("- Price: ", "${formatNumber(x.travel!.price)} \$"),
          ],
        ),
      ),
    )).toList();
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          value,
          style: TextStyle(
            color: isStatus && (value == "Active" || value == "active") ? Colors.green : Colors.black,
